...
const BolsasFdoAmericanoKraft = ({ isConnected }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  const folderName: 'lista2' | 'lista2-10' | 'lista2-10-2' | 'lista2-final' | 'lista2-10-final' | 'lista2-10-2-final' | 'lista3' | 'lista3-10' | 'lista3-10-2' | 'lista3-final' | 'lista3-10-final' | 'lista3-10-2-final' | 'lista4' | 'lista4-10' | 'lista4-10-2' | 'lista4-final' | 'lista4-10-final' | 'lista4-10-2-final' = router.pathname.split('/').slice(-2, -1)[0] as any;
...
export default BolsasFdoAmericanoKraft;