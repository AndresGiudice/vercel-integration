...
type AddToCartButtonProps = {
  ...
  list4: number;
  quantity: number;
  handleAddToCart: (systemCode: string, description: string, list4: number) => void;
};

const AddToCartButton: React.FC<AddToCartButtonProps> = ({ systemCode, description, list4, quantity, handleAddToCart }) => {
  return (
    <div
      ...
      onClick={() => {
        if (quantity > 0) {
          handleAddToCart(systemCode, description, list4);
        }
      }}
    >
