...
import Loading from "@/pages/components/Loading"; // importar el nuevo componente
            ...
            {loading ? (
              ...
              <div className="flex flex-wrap justify-evenly">
                {Object.entries(sortedGroupedBags).map(([additionalDescription, bags]) => (
                  ...
                  >
                    <img className="w-72 h-36 object-contain" src={`/Bobina Kraft ${additionalDescription}.png`} alt={additionalDescription} />
...
const BagCard: React.FC<BagCardProps & { folderName: keyof Bag | "lista2" | "lista2-10" | "lista2-10-2" | "lista2-final" | "lista2-10-final" | "lista2-10-2-final" | "lista3" | "lista3-10" | "lista3-10-2" | "lista3-final" | "lista3-10-final" | "lista3-10-2-final" | "lista4" | "lista4-10" | "lista4-10-2" | "lista4-final" | "lista4-10-final" | "lista4-10-2-final" }> = ({ bags, additionalDescription, addToCart, folderName }) => {
